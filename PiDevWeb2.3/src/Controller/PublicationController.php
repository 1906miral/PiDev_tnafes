...
class PublicationController extends AbstractController
{
     ...
     */
    //front
    public function show2(Publication $publication,Request $request ,PublicationRepository $repository,NormalizerInterface $Normalizer): Response
     ...
     */
    public function delete(Request $request, Publication $publication,NormalizerInterface $Normalizer): Response
    {      $commentaires = $this->getDoctrine()
        ->getRepository(Commentaire::class)
        ->findByIdpub($publication->getIdPub());
