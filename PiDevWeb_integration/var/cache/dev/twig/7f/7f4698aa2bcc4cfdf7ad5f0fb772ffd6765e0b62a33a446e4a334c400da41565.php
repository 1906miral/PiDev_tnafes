...
class __TwigTemplate_26ed9dc87a974eeff2ad88910f6d54a80dbc9aa117efa178994d2af200553681 extends Template
{
    private $source;
    private $macros = [];
...
";
        // line 3
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["form"]) || array_key_exists("form", $context) ? $context["form"] : (function () { throw new RuntimeError('Variable "form" does not exist.', 3, $this->source); })()), "captchaCode", [], "any", false, false, false, 3), 'row');
        echo "
    <button class=\"btn\">";
        // line 4
        echo twig_escape_filter($this->env, ((array_key_exists("button_label", $context)) ? (_twig_default_filter((isset($context["button_label"]) || array_key_exists("button_label", $context) ? $context["button_label"] : (function () { throw new RuntimeError('Variable "button_label" does not exist.', 4, $this->source); })()), "Envoyer")) : ("Envoyer")), "html", null, true);
        echo "</button>
";
        // line 5
...
{{ form_end(form) }}
", "reclamation/_form.html.twig", "C:\\Users\\miral\\OneDrive\\Bureau\\PiDevWeb2.33\\templates\\reclamation\\_form.html.twig");
    }
}
