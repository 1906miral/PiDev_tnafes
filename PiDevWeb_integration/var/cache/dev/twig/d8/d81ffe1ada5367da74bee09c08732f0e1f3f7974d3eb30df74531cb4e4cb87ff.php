...
class __TwigTemplate_73935f7e4fc38e9b21351eee46aad4740273a80a2595dd3d8f57a1d791ebd68b extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    public function block_simple_captcha_widget($context, array $blocks = [])
    {
        ...
        echo "
    ";
        $___internal_2b9fccf21f04e422c9a97214ff4d14d15375917ab140b64b22b03a84f90e6a49_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 2
        echo twig_spaceless($___internal_2b9fccf21f04e422c9a97214ff4d14d15375917ab140b64b22b03a84f90e6a49_);
    ...
    public function block_captcha_widget($context, array $blocks = [])
    {
        ...
        echo "
    ";
        $___internal_566a933b2179f42828a6ae4cfa405d9691561fa814bca1477f995aaa11aba2b2_ = ('' === $tmp = ob_get_clean()) ? '' : new Markup($tmp, $this->env->getCharset());
        // line 9
        echo twig_spaceless($___internal_566a933b2179f42828a6ae4cfa405d9691561fa814bca1477f995aaa11aba2b2_);
...
{% block captcha_widget %}
    {% apply spaceless %}
        ...
        {{ form_widget(form, { 'id': user_input_id, 'value': '' }) }}
    {% endapply %}
{% endblock %}", "@Captcha/captcha.html.twig", "C:\\Users\\miral\\OneDrive\\Bureau\\PiDevWeb2.33\\vendor\\captcha-com\\symfony-captcha-bundle\\Resources\\views\\captcha.html.twig");
    }
}
