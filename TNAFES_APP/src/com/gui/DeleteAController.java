 ...
 * @author HP
 */
public class DeleteAController implements Initializable {
    ...
    private void SelectedId(MouseEvent event) {
         comb.setOnAction(e->{
          String requete="select titre from activite where id_activite=?";
          try{
    ...
    private void supprimerAct(ActionEvent event) {
         ServiceActivite sa = new ServiceActivite();
        sa.supprimer(comb.getSelectionModel().getSelectedItem());
