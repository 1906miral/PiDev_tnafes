...
class ReclamationController extends AbstractController
{
     ...
     */
    public function index(NormalizerInterface $Normalizer,Request $request,ReclamationRepository $repository,FlashyNotifier $flashy,PaginatorInterface $paginator): Response
    {
     ...
     */
    public function index2(ReclamationRepository $repository,NormalizerInterface $Normalizer)
    {
     ...
     */
    public function edit(Request $request, Reclamation $reclamation,\Swift_Mailer $mailer,FlashyNotifier $flashy,NormalizerInterface $Normalizer): Response
    {
