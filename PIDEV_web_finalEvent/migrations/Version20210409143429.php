 ...
 */
final class Version20210409143429 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event ADD CONSTRAINT FK_3BAE0AA7C9486A13 FOREIGN KEY (id_categorie) REFERENCES categorie_event (idCategEvent)');
