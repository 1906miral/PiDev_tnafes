...
ArrayList<Categorie> list =ServiceCategorie.getInstance().getAllCategorie();
        ...
        {  
           ...
           // String urlm="https://www.englishspectrum.com/wp-content/uploads/2016/07/review-a.jpg";
            ...
            addButton(urlimage,ca);
       
        }
        
        
        add(sp);
        getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e->new HomeForm(current).show());
    }
...
//   }
    ...
    private void addButton(Image img,Categorie c) {
      ...
      // cnt.setLeadComponent(image);
         ...
         Label Nom = new Label("Nom de catégorie:"+c.getNom(),"NewsBottomLine");
         Label Description = new Label("Description:"+c.getDescription(),"NewsBottomLine");
