...
class EventController extends AbstractController
{
    ...
    {
        $a=$event->getNbPlace();
        $participation=$this->getDoctrine()->getRepository(Participation::class)->findByIdEvenement($event->getIdEvent());
     ...
     */
    public function searchEvent(EventRepository $repository, Request $request,NormalizerInterface $Normalizer):Response
    {
